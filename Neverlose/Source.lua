...
function Library:Window(Name, Color, Bind)
  ...
  Background.Size = UDim2.new(0.688, 0, 0.789, 0)
  
  Main.Parent = Background
  Main.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
  Main.BackgroundTransparency = 0.9
  Main.BorderSizePixel = 0
  Main.Size = UDim2.new(0.238, 0, 1, 0)
  
  Right_Line.Parent = Main
  Right_Line.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
  Right_Line.BackgroundTransparency = 0.9
  Right_Line.Position = UDim2.new(1, 0, 0.118, 0)
  Right_Line.Size = UDim2.new(3.194, 0, 0.005, 0)
  
  Container.Parent = Main
  Container.BackgroundTransparency = 1
  Container.BorderSizePixel = 0
  Container.Position = UDim2.new(0, 0, 0.131, 0)
  Container.Size = UDim2.new(1, 0, 0.759, 0)
  ...
  function Container_Functions:Label(Name)
    ...
    Barrier.Size = UDim2.new(0.977, 0, 0.081, 0)
    ...
    Label.Text = Name
    Label.TextColor3 = Color3.fromRGB(186, 184, 255)
  ...
  function Container_Functions:Tab(Name, Icon)
    ...
    Barrier.Parent = Container
    Barrier.BackgroundTransparency = 1
    Barrier.Size = UDim2.new(0.977, 0, 0.095, 0)
    
    Button.Parent = Barrier
    Button.AutoButtonColor = false
    Button.BackgroundColor3 = Color3.fromRGB(45, 59, 138)
    Button.BorderSizePixel = 0
    Button.Position = UDim2.new(0.063, 0, 0, 0)
    Button.Size = UDim2.new(0.913, 0, 0.88, 0)
    Button.TextTransparency = 1
    
    Image.Parent = Button
    Image.BackgroundTransparency = 1
    Image.Position = UDim2.new(0.094, 0, 0.182, 0)
    Image.Size = UDim2.new(0.131, 0, 0.682, 0)
    Image.Image = Icon
    Image.ImageColor3 = Color3.fromRGB(186, 184, 255)
    
    Title.Parent = Button
    Title.Position = UDim2.new(0.3, 0, 0.273, 0)
    ...
    New_Container.Position = UDim2.new(0.263, 0, 0.157, 0)
    New_Container.Size = UDim2.new(0.713, 0, 0.841, 0)
    ...
    Button.MouseButton1Click:Connect(function()
      ...
      if New_Container.Visible == false then
        ...
        Tween:Create(Button, TweenInfo.new(0.1), {BackgroundTransparency = 0.25}):Play()
              ...
              for _,v in pairs(Container:GetDescendants()) do
                ...
                if v:IsA("GuiBase") then
                  ...
                  if (v.Name == "Toggle" and v.BoolValue.Value == true) then
                    ...
                    v.Button_Name.TextColor3 = Color3.fromRGB(124, 134, 145)
                    v.Frame.Frame.BackgroundColor3 = Color3.fromRGB(124, 134, 145)
                    ...
                    spawn(function()
                      ...
                      Tween:Create(v.Frame.Frame, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {BackgroundColor3 = Color3.fromRGB(130, 153, 213), Position = UDim2.new(0.545, 0, 0.152, 0)}):Play()
    ...
    function Tab_Functions:Section(Name)
      ...
      Text.TextColor3 = Color3.fromRGB(186, 184, 255)
      Text.TextTransparency = 0.16
      ...
      local function Add_Space()
        ...
        if Main:FindFirstChildWhichIsA("Frame") and Main:FindFirstChildWhichIsA("Frame"):FindFirstChildWhichIsA("Instance") or Main:FindFirstChildWhichIsA("TextButton") then
          ...
          Space.BackgroundTransparency = 0.7
      ...
      function Section_Functions:Button(Name, Callback)
        ...
        local Button, Text, Image = New("TextButton"), New("TextLabel"), New("ImageLabel")
        ...
        Image.Parent = Button
        Image.BackgroundTransparency = 1
        Image.Position = UDim2.new(0.89, 0, 0.135, 0)
        Image.Size = UDim2.new(0.096, 0, 0.932, 0)
        Image.Image = "rbxassetid://12974189594"
        Image.ImageColor3 = Color3.fromRGB(124, 134, 145)
        ...
        Text.Font = Enum.Font.Gotham
        Text.Text = Name
        Text.TextColor3 = Color3.fromRGB(124, 134, 145)
        Text.TextScaled = true
        Text.TextXAlignment = Enum.TextXAlignment.Left
        ...
        Button.MouseButton1Click:Connect(function()
          ...
          Tween:Create(Image, TweenInfo.new(0.01), {ImageColor3 = Color3.fromRGB(130, 153, 212)}):Play()
          Tween:Create(Text, TweenInfo.new(0.01), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()

          task.wait(0.07)
          
          Tween:Create(Image, TweenInfo.new(0.15), {ImageColor3 = Color3.fromRGB(124, 134, 145)}):Play()
          Tween:Create(Text, TweenInfo.new(0.15), {TextColor3 = Color3.fromRGB(124, 134, 145)}):Play()
      ...
      function Section_Functions:Toggle(Name, Bool, Callback)
        ...
        if Bool == true then
          ...
          Circle.BackgroundColor3 = Color3.fromRGB(130, 153, 213)
          Circle.Position = UDim2.new(0.545, 0, 0.152, 0)
          
          Path.BackgroundColor3 = Color3.fromRGB(20, 23, 33)
          
        else
          
          Text.TextColor3 = Color3.fromRGB(124, 134, 145)
          
          Circle.BackgroundColor3 = Color3.fromRGB(124, 134, 145)
          Circle.Position = UDim2.new(0.1, 0, 0.152, 0)
          
          Path.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        ...
        Button.MouseButton1Click:Connect(function()
          ...
          if Bool == true then
            ...
            Tween:Create(Circle, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {BackgroundColor3 = Color3.fromRGB(130, 153, 213), Position = UDim2.new(0.545, 0, 0.152, 0)}):Play()
            Tween:Create(Path, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {BackgroundColor3 = Color3.fromRGB(20, 23, 33)}):Play()
            
          else
            
            Tween:Create(Text, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {TextColor3 = Color3.fromRGB(124, 134, 145)}):Play()
            Tween:Create(Circle, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {BackgroundColor3 = Color3.fromRGB(124, 134, 145), Position = UDim2.new(0.1, 0, 0.152, 0)}):Play()
            Tween:Create(Path, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {BackgroundColor3 = Color3.fromRGB(0, 0, 0)}):Play()
      ...
      function Section_Functions:Slider(Name, Minimum, Maximum, Start, Callback)
        ...
        Button.MouseEnter:Connect(function()
          ...
          Tween:Create(SlideCircle, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(112, 134, 182)}):Play()
          
        end)
        
        Button.MouseLeave:Connect(function()
          
          Tween:Create(Text, TweenInfo.new(0.3), {TextColor3 = Color3.fromRGB(124, 134, 145)}):Play()
          
          Tween:Create(SlideCircle, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(130, 153, 213)}):Play()
          ...
          if v:IsA("GuiBase") then
            ...
            if (v.Name == "Toggle" and v.BoolValue.Value == true) then
              ...
              spawn(function()
                ...
                Tween:Create(v.Frame, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {BackgroundColor3 = Color3.fromRGB(20, 23, 33)}):Play()
                Tween:Create(v.Frame.Frame, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {BackgroundColor3 = Color3.fromRGB(130, 153, 213), Position = UDim2.new(0.545, 0, 0.152, 0)}):Play()
